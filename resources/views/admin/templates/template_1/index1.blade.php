                                    ...
                                    <div class="tab_area">
                                        ...
                                        <div id="Gallary" class="tabcontent">
                                            <div class="reviewBox">
                                                ...
                                                <div id="video" class="tab_galcontent"> <div class="gall_top_bttn"> <div class="flx upld_file">  <div class="slidsho_txt" > <label for="file_upload" class="custom-file-upload">  Add a Video </label><input type="file"  accept="video/*" id="file_upload"  id="vid_upload" name="upld_vid" class="upld_video" ></div> <div class="publish_btn"><button id ="save_media_video"class="btn btn-danger">Publish</button></div></div> </div><div class="gallery_video"><div class="row vid_row"><div class="col-md-4 pic_gal_vid remove_vid`+ user_id +`"><div class="image-area_pic"><video width="200" height="200" controls=""><source src="{!!$base_url!!}/public/images/upload_file/1692724078.mp4" alt=""></video><a class="remove-image_pic" onclick="delete_request_vid(`+user_id+`)"  style="display: inline;">&#215;</a></div></div><div class="col-md-4 pic_gal_vid remove_vid`+ user_id +`"><div class="image-area_pic"><video width="200" height="200" controls=""><source src="{!!$base_url!!}/public/user_templates/images/1692724078.mp4" alt=""></video><a class="remove-image_pic" onclick="delete_request_vid(`+user_id+`)"  style="display: inline;">&#215;</a></div></div> </div></div></div>
