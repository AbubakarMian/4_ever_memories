...
// console.log('isAuthenticated',isAuthenticated);
    ...
    $(document).ready(function() {
        ...
        $('#save_story').on('click', function() {
            ...
            if (storyt == "") {
                show_error_modal_with_msg(null,'Please Write A Title');
                return;
            }
            if (storyd == "") {
                show_error_modal_with_msg(null,'Please Write A detail');
                return;
            }
            if (storyp == "") {
                show_error_modal_with_msg(null,'Please Add A Picture');
                return;
            }
            $('#loaderModal').modal('toggle');
            var formData = new FormData();
